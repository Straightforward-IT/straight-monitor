...
const appleWalletPassRoutes = require('./routes/integrations/appleWalletPassRoutes');
...
const publicEmployeeDocumentRoutes = require('./routes/public/publicEmployeeDocumentRoutes');
const employeeDocumentRoutes = require('./routes/employee/employeeDocumentRoutes');
...
const flipFusionRoutes = require('./routes/integrations/flipFusionRoutes');
...
app.use('/api/flip-fusion', flipFusionRoutes);
