...
const paketVorlageRoutes = require('./routes/paketVorlageRoutes');
...
const docusealRoutes = require('./routes/docusealRoutes');
...
const flipFileRoutes = require('./routes/flipFileRoutes');
const flipCalendarRoutes = require('./routes/flipCalendarRoutes');
